export enum Currency {
  usd, aed, afn, amd, ang, aoa, ars, aud, awg, azn, bam, bbd, bdt,
  ...
  pyg, qar, ron, rsd, rub, rwf, sar, sbd, scr, sek, sgd, shp, sle, sll,
  sos, srd, std, szl, thb, tjs, top,
  ttd, twd, tzs, uah, ugx, uyu, uzs, vnd, vuv, wst, xaf, xcd, xof, xpf,
  yer, zar, zmw
}
